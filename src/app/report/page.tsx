    ...
    return (
      <div className="flex flex-col min-h-screen bg-brand-bg text-white">
        ...
        <div className="flex-1 flex flex-col items-center justify-center py-20 text-gray-500">
          ...
          <p className="text-xs">Loading report information...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex flex-col min-h-screen bg-brand-bg text-white">
        ...
        <div className="flex-1 flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-sm text-gray-400 mt-2">The issue report you are looking for does not exist or has been deleted.</p>
          <button
      ...
      <div className="flex-1 mx-auto max-w-5xl w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {report.aiSummary && (
              <div className="glass-panel p-6 rounded-3xl space-y-4 relative overflow-hidden">
                ...
                <div className="pt-2 flex items-center gap-2 text-xs text-gray-400">
                  ...
                  <span>Routed Municipality: <strong className="text-white font-bold">{report.assignedDepartment}</strong></span>
                </div>
              </div>
            )}
              ...
              {user ? (
                <form onSubmit={handleCommentSubmit} className="flex gap-3">
                  <input
                    ...
                    placeholder="Provide additional details or local status updates..."
                ...
                <p className="text-xs text-gray-500 italic">Sign in to add a status update comment.</p>
              )}

              <div className="space-y-4 max-h-96 overflow-y-auto pr-1">
                {comments.length === 0 ? (
                  <p className="text-xs text-gray-500 font-light">No comments or validation notes submitted yet.</p>
                ) : (
                  comments.map((comm) => (
          ...
          <div className="space-y-6">
            ...
            <div className="glass-panel p-6 rounded-3xl space-y-4">
              <h3 className="text-xs font-bold text-white uppercase tracking-wider">Community Validation</h3>
              <p className="text-xs text-gray-400 font-light">Confirm this issue to prioritize it in municipal routing queues.</p>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <span className="text-[9px] text-gray-500">Upvotes</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[9px] text-gray-500">Confirmations</span>
                </button>
              </div>
            </div>
                ...
                {statusHistory.length > 0 ? (
                    ...
                    <div key={i} className="relative">
                      ...
                      <div className="pl-2">
                        <span className="text-xs font-bold text-white uppercase tracking-wider">
                          Status Changed: {statusLabels[h.toStatus as keyof typeof statusLabels] || h.toStatus}
                        </span>
                  ...
                  <>
                    <div className="relative">
                      <div className="absolute -left-[13px] top-1 h-3.5 w-3.5 rounded-full border-2 border-brand-primary bg-brand-bg shadow-md" />
                      <div className="pl-2">
                        <span className="text-xs font-bold text-white uppercase tracking-wider">Report Filed</span>
                        <p className="text-[10px] text-gray-400 mt-0.5">{new Date(report.createdAt).toLocaleDateString()}</p>
                        <p className="text-[11px] text-gray-300 mt-1 font-light italic">"Report created and analyzed by AI."</p>
                      </div>
                    </div>
